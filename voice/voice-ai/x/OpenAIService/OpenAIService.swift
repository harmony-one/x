...
//                    conversation.append(Message(role:"system", content: aitext))
    ...
    func setConversationContext() -> [Message] {
        ...
        contextMessage.append(Message(role: "system", content:"We are having a face-to-face voice conversation. NEVER apologize. NEVER say bye. NEVER end with questions. NEVER mention about your model cutoff. NEVER mention you are an AI. Never say that your name is Open AI. Adhere to these guidelines strictly. Keep responses 1 sentence unless the user wants to expand."))
