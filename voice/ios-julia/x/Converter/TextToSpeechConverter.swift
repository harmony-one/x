...
class TextToSpeechConverter {
    ...
    func convertTextToSpeech(text: String, pitch: Float = 1.0, volume: Float = 1.0, language: String = "en-US") {
        ...
        utterance.voice = AVSpeechSynthesisVoice(identifier: "com.apple.voice.enhanced.en-US.Evan") ?? AVSpeechSynthesisVoice(identifier: "com.apple.speech.voice.compact.en-US.Samantha")
