2023-12-7 Thu: Re-edited team video demos, to include demos and full face video to make them more interesting. Uploaded all videos onto a [Twitter thread](https://x.com/harmonyprotocol/status/1732863028373467527?s=20). Synced with Frank on VoiceAI data, and synced with Julia on using command line to pull the data.
